    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm max-w-sm leading-relaxed">
              Upload a PDF and get grounded, cited answers pulled straight from its content —
              no hallucinated guesses, just what's actually in the document.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          ...
          <h1 className="font-serif text-3xl mb-1 text-paper">Welcome back</h1>
          <p className="text-sm text-slate-400 mb-8">Sign in to chat with your documents.</p>
          ...
          <p className="text-sm text-slate-400 mt-6">
            No account?{' '}
            <Link to="/register" className="text-mossLight hover:text-moss font-medium">
              Create one
            </Link>
          </p>
        </div>
